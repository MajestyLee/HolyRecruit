...
public class CompanyDAO extends HibernateDaoSupport {
	...
	public static final String COMSTART = "comstart";
	public static final String COMNUM = "comnum";
	public static final String COMSTAGE = "comstage";
	public static final String COMFIELD = "comfield";
	public static final String COMINTRODUCE = "comintroduce";
	...
	public List findByComstart(Object comstart) {
		return findByProperty(COMSTART, comstart);
	}

	public List findByComnum(Object comnum) {
		return findByProperty(COMNUM, comnum);
	}

	public List findByComstage(Object comstage) {
		return findByProperty(COMSTAGE, comstage);
	}

	public List findByComfield(Object comfield) {
		return findByProperty(COMFIELD, comfield);
	}

	public List findByComintroduce(Object comintroduce) {
		return findByProperty(COMINTRODUCE, comintroduce);
	}

	public List findByCompage(Object compage) {
		return findByProperty(COMPAGE, compage);
	}
