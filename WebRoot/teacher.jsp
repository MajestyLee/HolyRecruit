            	...
            	<dl class="company_center_content">
                    ...
                    <s:iterator value="users" id="u">
			                	...
			                	<ul class="reset my_jobs">
				                			                            	<li data-id="149594">
		                                    <h3>
		                                        <a target="_blank" title="<s:property value="#u.username" />" ><s:property value="#u.username" /></a> 
		                                        <span>[DHU]</span>
		                                        						                        		                                    </h3>
		                                    		                                  		
		                                  			                                    <div><s:property value="#u.useremail" /> </div>
		                                    		                                    				 
			                                    		                                    		                                    		                                    <div class="links">
		                                    			                                       	
		                                       	    <!-- <a target="_blank" class="job_edit" href="create.html?positionId=149594">编辑</a>  -->
			                                        <a class="job_del" href='<s:url action="deleteusers"><s:param  name="id" value="#u.idusers" /></s:url>'>删除</a>
		                                    </div>
		                                    		                                </li>
	                                	                           	</ul>
			                    			                </form>
