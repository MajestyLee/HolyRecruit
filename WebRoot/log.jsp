...
<title>登录-Holy网-最专业的互联网招聘平台</title>
		...
		<div class="login_header">
		 ...
		 <div class="login_box">
        	<form id="loginForm" action="login" method="post">
				<input type="text" id="username" name="username" tabindex="1" placeholder="请输入用户名" />
			    ...
			    <a href="res.jsp" class="fr" target="_blank">忘记密码？</a>
			...
			<div class="login_right">
				...
				<div>&nbsp;</div>
				<div>还没有Holy帐号？</div>
				<a  href="reg.jsp"  class="registor_now">立即注册</a>
			</div>
        </div>
