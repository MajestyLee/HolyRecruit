<%@ page language="java" import="java.util.*" import="com.example.jobtest.*"  pageEncoding="utf-8"%>
...
<body id="login_bg">
	<div class="login_wrapper">
		<div class="login_header">
            <a href=""><img src="style/images/logo_white.png" width="285" height="62" alt="holy招聘" /></a>
		...
		<div class="login_box">
        	<form id="loginForm" method="post" action="register">
            	...
            	<label class="fl registerJianJu" for="checkbox">
            		<input type="checkbox" id="checkbox" name="checkbox" checked  class="checkbox valid" />我已阅读并同意<a href="Holy.txt" target="_blank">《holy用户协议》</a>
           		</label>
		...
		<div>&nbsp;</div>
            	<div>已有holy帐号</div>
		<div>&nbsp;</div>
            	<a  href="log.jsp"  class="registor_now">直接登录</a>
	    	 ...
	    	 $("#loginForm").validate({
			    	...
			    	/*submitHandler:function(form){
			            ...
			            $.ajax({
			            	...
			            	url:'~/src/com/holy/action/UserAction.java',
